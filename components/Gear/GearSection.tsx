...
const gearItems = [
  {
    ...
    background: <div className="absolute inset-0 bg-gradient-to-br from-blue-400/10 via-transparent to-purple-600/20" />,
    className: "lg:row-start-1 lg:row-end-3 lg:col-start-1 lg:col-end-2",
  },
  {
    Icon: CameraIcon,
    name: "Insta360 Link 2",
    description: "4K camera with tracking and gesture control, useful for video calls and content creation.",
    href: "/gear",
    image: "/images/gear/insta360-link-2.jpg",
    background: <div className="absolute inset-0 bg-gradient-to-br from-pink-400/10 via-transparent to-purple-600/20" />,
  ...
  },
  {
    Icon: HomeIcon,
    name: "Standing Desk",
    description: "Adjustable standing desk for better posture and health during long work sessions.",
    href: "/gear",
    image: "/images/gear/standing-desk.jpg",
    background: <div className="absolute inset-0 bg-gradient-to-br from-amber-400/10 via-transparent to-purple-600/20" />,
    className: "lg:col-start-2 lg:col-end-3 lg:row-start-2 lg:row-end-3",
  },
  {
    Icon: GlobeIcon,
    name: "1 Gigabit Fiber Optic",
    description: "1Gbps fiber internet connection for stable development, streaming, and uploads.",
    href: "/gear",
  ...
  },
  {
    ...
    description: "WordPress development environment with local servers, debugging tools, and premium plugins.",
    href: "/gear",
  ...
  },
  {
    ...
    background: <div className="absolute inset-0 bg-gradient-to-br from-purple-400/10 via-transparent to-indigo-600/20" />,
