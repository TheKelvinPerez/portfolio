...
export default function BookCard({ book, onClick }: BookCardProps) {
  return (
    <div
      className="group cursor-pointer rounded-2xl bg-gradient-to-br from-purple-800/40 to-purple-900/60 backdrop-blur-sm border border-purple-500/70 overflow-hidden transition-all duration-300 hover:scale-105 hover:border-purple-400/80 shadow-lg hover:shadow-lg hover:shadow-purple-500/20 lg:h-[500px] flex flex-col"
      onClick={onClick}
    >
      ...
      <div className="p-4 flex flex-col justify-between h-40 flex-shrink-0">
        <div>
