...
export default function LogoCloud() {
  return (
    <div className="relative z-40 mx-auto mt-2 md:mt-4 flex min-w-0 max-w-full flex-col gap-4 overflow-hidden px-4 text-white sm:px-6 lg:max-w-[1080px] lg:gap-2 lg:px-0">
      <h2 
